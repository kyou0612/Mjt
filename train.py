...
Original file is located at
    https://colab.research.google.com/drive/1JOhDbQMrYOLKXmbMlGuUd_oXX8GW9xhs
"""
...
def run_experiment(model):
    ...
    while t < epochs:
      for i in range(20):
        dataset = tf.data.TFRecordDataset(train_path + str(i+1)+'.tfrecords').map(deserialize_example_1p).batch(100000)
